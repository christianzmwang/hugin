...
export default function AuthForm({ mode }: AuthFormProps) {
      ...
      if (mode === 'signup') {
        ...
        if (data.requiresVerification) {
          ...
          if (signInResult?.error) {
            ...
            // Route through post-login to decide based on access
  ...
  {/* Hugin image in bottom left corner */}
  ...
  <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="shadow-sm space-y-6">
            <div className="relative">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="relative block w-full px-1 py-2 bg-transparent border-0 border-b border-gray-600 text-white placeholder-gray-500 focus:outline-none focus:border-red-600 focus:ring-0 focus:z-10 text-sm"
                placeholder="Email"
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className={`relative block w-full px-1 py-2 ${mode === 'signup' ? 'pr-16' : 'pr-10'} bg-transparent border-0 border-b border-gray-600 text-white placeholder-gray-500 focus:outline-none focus:border-red-600 focus:ring-0 focus:z-10 text-sm`}
          ...
          <div>
            <button
              ...
              className="group relative w-full flex justify-center py-2.5 px-3 border border-transparent text-sm font-medium text-white bg-red-800 hover:bg-red-900 focus:outline-none focus:ring-2 focus:ring-red-400 disabled:opacity-50 disabled:cursor-not-allowed"
            >
