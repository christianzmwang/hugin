        ...
        <div className="px-3 md:px-6 py-3">
          <div className="flex items-center gap-2">
            ...
            <nav className="flex items-center gap-3">
              ...
              <Link
                href="/configuration"
                className={`group relative px-2 py-2 text-xs md:text-sm inline-flex items-center gap-2 ${isActive('/configuration') ? 'text-white/90' : 'text-white/80'}`}
                title="Configuration"
              >
                <Settings size={16} />
              ...
              <Link
                href="/sandbox"
                className={`group relative px-2 py-2 text-xs md:text-sm inline-flex items-center gap-2 ${isActive('/sandbox') ? 'text-white/90' : 'text-white/80'}`}
              >
